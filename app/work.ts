...
export const workProjects: WorkProject[] = [
  ...
  {
    slug: "automotive-ads-automation",
    number: "03",
    title: "Automotive ads automation",
    category: "Confidential paid-search programme",
    status: "Historical professional experience",
    summary: "Contributing PPC expertise to the evolution of technology that automated Google Ads activity across a very large and constantly changing vehicle inventory.",
    challenge: "Vehicle listings change quickly and at high volume. Building and maintaining accurate paid-search activity manually across such an inventory creates a significant problem of scale, freshness and consistency.",
    approach: "As part of the PPC team, Luke worked with the automation in practice and contributed campaign knowledge, analysis, optimisation feedback and client-account context to its ongoing evolution. He did not create or design the underlying software.",
    evidence: ["Automation supporting a large vehicle-listing inventory", "Hands-on paid-search operations and optimisation", "Practical feedback into the technology's evolution", "Client identity and proprietary details kept confidential"],
    next: "This historical case study intentionally omits the client, proprietary technology and unverified results. Its relevance is direct experience working responsibly with advanced automation before AI became mainstream.",
    accent: "case-card--violet",
  },
  {
